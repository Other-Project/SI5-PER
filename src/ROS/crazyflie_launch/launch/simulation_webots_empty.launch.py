...
def generate_launch_description():
    ...
    # Start Webots WITH EMPTY WORLD
    ld.add_action(
        IncludeLaunchDescription(
            PythonLaunchDescriptionSource(os.path.join(get_package_share_directory("webots"), "launch", "robot_launch_empty_world.py")),  # ← CHANGEMENT ICI
        )
    )
