...
def generate_launch_description():
    ...
    crazyflies_yaml = os.path.join(pkg_multiranger_bringup, "config", "crazyflie_real_crazyswarm2.yaml")
    ...
    rviz_config_path = os.path.join(get_package_share_directory("crazyflie_launch"), "config", "real_mapping.rviz")
