...
ARGUMENTS = [
    DeclareLaunchArgument(
        "use_sim_time", default_value="false", choices=["true", "false"], description="Use simulation (Gazebo) clock if true"
    ),
    DeclareLaunchArgument("robot_name", default_value="crazyflie", description="Robot name"),
...
def generate_launch_description():
    ...
    # RViz2
    rviz2 = Node(package="rviz2", executable="rviz2", name="rviz2", arguments=["-d", rviz_config_file], output="screen")
