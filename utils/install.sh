...
# Enable universe
sudo apt update -y
sudo apt install software-properties-common lsb-release gnupg curl -y
...
sudo apt install ros-jazzy-desktop \
    ...
    ros-jazzy-motion-capture-tracking ros-jazzy-tf-transformations ros-jazzy-teleop-twist-keyboard \
    gz-harmonic ros-jazzy-ros-gz \
    "ros-jazzy-crazyflie*" swig \
    -y
